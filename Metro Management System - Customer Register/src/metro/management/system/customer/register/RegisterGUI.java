...
public class RegisterGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/5fe2be0320916.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");

        jLabel2.setFont(new java.awt.Font("Perpetua Titling MT", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("ZDM METRO");
    ...
    // Validate input (you can add more validation if needed)
        ...
        JOptionPane.showMessageDialog(null, "Passwords do not match. Please enter the password again.");
        ...
        try {
            String query = "INSERT INTO customer_registration (username, CNIC, password) VALUES (?, ?, ?)";
            sss = sos.prepareStatement(query);
            sss.setString(1, username);
            sss.setString(2, CNIC);
            sss.setString(3, password);

            int affectedRows = sss.executeUpdate();
